                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="./detailscours.php?id=<?php echo $course['id']; ?>" class="bg-orange-400 text-white py-2 px-6 rounded-lg hover:bg-orange-500 focus:outline-none transition duration-300 transform hover:scale-105">
                                En savoir plus
                            </a>
                        </div>
                        </div>
