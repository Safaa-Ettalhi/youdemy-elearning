...
<body>
    ...
    <nav class="fixed w-full bg-white/95 backdrop-blur-sm z-50">
        ...
        <section class="hero flex pt-10 flex-col items-center justify-center mt-20">
            <div class="mb-4">
                <img src="./done.png" alt="succes" height="400px" width="400px"
                    class="mx-auto ">
                   
            </div>
            <p class="text-green-700 text-xl font-bold mb-4">Vous êtes inscrit à ce cour avec succes</p>
            <div class="mt-6 flex gap-4">
            <a href="./mescours.php"
                        class="mx-auto px-6 py-3 bg-orange-400 text-white font-semibold rounded-full hover:bg-orange-500 transition">
                        Voir Mes Cours
            </a>
            <a href="./catalogecours.php"
                        class="mx-auto px-6 py-3 bg-white text-orange-400 border border-orange-400 font-semibold rounded-full hover:bg-orange-500 hover:text-white transition">
                        Voir Cours
            </a>
